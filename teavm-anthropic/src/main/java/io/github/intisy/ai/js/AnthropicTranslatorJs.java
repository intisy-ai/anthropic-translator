...
/**
 * TeaVM JS export surface over the Anthropic translator (round-trip smoke export plus the
 * {@link AnthropicTranslator} non-streaming/streaming exports). Mirrors core-ir's
 * {@code io.github.intisy.ai.js.CoreIrJs} export style.
 */
public final class AnthropicTranslatorJs {
    private AnthropicTranslatorJs() {
    }
