 ...
 */
export declare function anthropicDecodeRequest(wireJson: string): string;
/**
 ...
 */
export declare function anthropicDecodeResponse(wireJson: string): string;
/**
 * An IR request to Anthropic wire JSON.
 *
 * @param irRequestJson - the canonical IR request
 * @returns the request in Anthropic's own format
 */
export declare function anthropicEncodeRequest(irRequestJson: string): string;
/**
 * An IR response to Anthropic wire JSON.
 *
 * @param irResponseJson - the canonical IR response
 * @returns the response in Anthropic's own format
 */
export declare function anthropicEncodeResponse(irResponseJson: string): string;
/**
 * Opens a decode handle for one connection's stream.
 *
 * @returns a handle carrying that connection's decode state
 */
export declare function anthropicNewStreamDecoder(): JsStreamDecoderHandle;
/**
 * Opens an encode handle for one connection's stream.
 *
 * @returns a handle carrying that connection's encode state
 */
export declare function anthropicNewStreamEncoder(): JsStreamEncoderHandle;
/**
